...
application.controller('GroupCtrl', ['$scope', '$stateParams', '$window', '$http', '$rootScope', function ($scope, $stateParams, $window, $http, $rootScope) {
    ...
    socket.on('update_current_listeners', function (msg) {
        console.log(msg.listeners);
        // This is where we'll receive all the updates to who is currently listening and use it to update the appropriate widgets
    });

    // Handle updates to the playlist
    socket.on('update_current_playlist', function (msg) {
